 ...
 * Description:   Dialog to display about information.  Some simple text *
 *                formatting is possible such as centre text, change     *
 *                font size or highlight text as a hyperlink.            *
 *************************************************************************
 */
